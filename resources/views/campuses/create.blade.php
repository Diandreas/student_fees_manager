        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Créer un nouveau campus</h2>
                ...
                <form action="{{ route('campuses.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Informations de l'école</h3>
                            <div class="space-y-2">
                                <p class="text-sm text-gray-600">
                                    <span class="font-medium">École :</span> {{ $school->name }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    <span class="font-medium">Total des filières :</span> {{ $school->fields->count() }}
                                </p>
                                <p class="text-sm text-gray-600">
                                    <span class="font-medium">Total des étudiants :</span> {{ $school->students->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
