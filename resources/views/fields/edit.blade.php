            ...
            <div class="card-body">
                <form action="{{ route('fields.update', $field) }}" method="POST">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('education_level_id') border-red-500 @enderror" 
                                    ...
                                    <option value="{{ $level->id }}" {{ old('education_level_id', $field->education_level_id) == $level->id ? 'selected' : '' }}>
                                        {{ $level->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-input @error('fees') border-red-500 @enderror" 
                                       id="fees" name="fees" value="{{ old('fees', $field->fees) }}" required min="0" step="1000">
                                @error('fees')
                                <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-input @error('duration') border-red-500 @enderror" 
                                       id="duration" name="duration" value="{{ old('duration', $field->duration) }}" required min="1" max="10">
                                @error('duration')
                                <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-input @error('max_installments') border-red-500 @enderror" 
                                       id="max_installments" name="max_installments" value="{{ old('max_installments', $field->max_installments) }}" required min="1" max="12">
                    ...
                    <div class="flex justify-end mt-6 space-x-3">
                        <a href="{{ route('fields.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">
                            Annuler
                        </a>
