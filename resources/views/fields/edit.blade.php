        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Modifier la filière</h2>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select name="campus_id" id="campus_id" required
                                        ...
                                        @foreach($campuses as $campus)
                                            <option value="{{ $campus->id }}" {{ old('campus_id', $field->campus_id) == $campus->id ? 'selected' : '' }}>
                                                {{ $campus->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="level" id="level" required
                                        ...
                                        <option value="bac" {{ old('level', $field->level) == 'bac' ? 'selected' : '' }}>Baccalauréat</option>
                                        <option value="master" {{ old('level', $field->level) == 'master' ? 'selected' : '' }}>Master</option>
                                        <option value="doctorat" {{ old('level', $field->level) == 'doctorat' ? 'selected' : '' }}>Doctorat</option>
                                    </select>
                                    @error('level')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="fees" id="fees" value="{{ old('fees', $field->fees) }}" required
                                ...
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-lg font-semibold text-gray-900">{{ $field->students->count() }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white p-4 rounded-lg shadow">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-lg font-semibold text-gray-900" id="potentialRevenue">{{ $field->fees * $field->students->count() }} FCFA</p>
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.getElementById('fees').addEventListener('input', function() {
        ...
        const students = {{ $field->students->count() }};
        document.getElementById('potentialRevenue').textContent = (fees * students) + ' FCFA';
    });
</script>
@endpush
@endsection
